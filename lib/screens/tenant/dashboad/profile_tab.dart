          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: const [
                      Text('Profile', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: _C.text)),
                      SizedBox(height: 2),
                      Text('Manage your account', style: TextStyle(fontSize: 13, color: _C.textSub)),
                    ],
                  ),
              ...
              _buildMenuSection('Account', [
                ...
                _MenuItem(Icons.favorite_rounded, 'Saved Listings'),
                _MenuItem(Icons.notifications_outlined, 'Notifications'),
                _MenuItem(Icons.search_rounded, 'Saved Searches'),
              ]),
              const SizedBox(height: 20),
        ...
        children: [
          Stack(
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  width: 22, height: 22,
                  decoration: BoxDecoration(color: _C.primary, shape: BoxShape.circle, border: Border.all(color: _C.bgCard, width: 2)),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Sarah Johnson', style: TextStyle(fontSize: 19, fontWeight: FontWeight.w800, color: _C.text)),
                const SizedBox(height: 3),
                const Text('sarah.j@email.com', style: TextStyle(fontSize: 13, color: _C.textSub)),
                const SizedBox(height: 8),
                Row(
                  children: [
                    Container(
                      ...
                      child: const Text('Tenant', style: TextStyle(fontSize: 11, color: _C.primary, fontWeight: FontWeight.w700)),
                    ),
                    const SizedBox(width: 8),
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                      decoration: BoxDecoration(color: _C.tagActive, borderRadius: BorderRadius.circular(20)),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: const [
                          Icon(Icons.verified_rounded, size: 11, color: _C.tagActiveText),
                          SizedBox(width: 3),
                          Text('Verified', style: TextStyle(fontSize: 11, color: _C.tagActiveText, fontWeight: FontWeight.w700)),
                        ],
                      ),
                    ),
                  ],
  ...
  Widget _buildStatsRow() {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: _C.primary.withOpacity(0.28), blurRadius: 16, offset: const Offset(0, 6))],
      ),
      child: Row(
        children: [
          _StatCell(value: '6', label: 'Saved'),
          _VertDivider(),
          _StatCell(value: '3', label: 'Inquiries'),
          _VertDivider(),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(title.toUpperCase(), style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: _C.textLight, letterSpacing: 1.0)),
        ),
        Container(
          decoration: BoxDecoration(
            color: _C.bgCard,
            ...
            children: List.generate(items.length, (i) {
              ...
              return Column(
                children: [
                  ...
                  if (!isLast) Divider(height: 1, indent: 54, endIndent: 16, color: _C.divider),
                ],
              );
            }),
          ),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: const [
            ...
            SizedBox(width: 8),
            Text('Log Out', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Color(0xFFD63031))),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Container(
              width: 36, height: 36,
              decoration: BoxDecoration(color: _C.inputBg, borderRadius: BorderRadius.circular(10)),
              child: Icon(item.icon, size: 18, color: _C.primary),
            ),
            const SizedBox(width: 14),
            Expanded(child: Text(item.label, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w500, color: _C.text))),
            const Icon(Icons.chevron_right_rounded, size: 20, color: _C.textLight),
          ],
        ),
      ),
    );
