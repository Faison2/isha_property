...
class _TenantLoginPageState extends State<TenantLoginPage> {
  ...
  static const Color _primary = Color(0xFF5B50C8);
  static const Color _bgTop = Color(0xFFECEBF8);
  static const Color _bgBottom = Color(0xFFF5F5FB);
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const Row(
                      children: [
                        Expanded(child: Divider(color: Color(0xFFD8D8E8))),
                        Padding(
